...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Dodawnie zajęć</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('classes.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="slots" type="number" min="1" class="form-control @error('slots') is-invalid @enderror" name="slots" value="{{ old('slots') }}" required autocomplete="slots" autofocus>
