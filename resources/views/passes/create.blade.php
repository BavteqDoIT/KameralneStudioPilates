...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Dodawnie Karnetu</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('passes.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" maxlength="1500" type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description') }}" autofocus></textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="number" min="1" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price') }}" required autocomplete="price" autofocus>
